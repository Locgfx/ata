...
class UAppleSignUpAddDetails extends StatefulWidget {
  UAppleSignUpAddDetails({
    Key? key,
  }) : super(key: key);
  @override
  State<UAppleSignUpAddDetails> createState() => _UAppleSignUpAddDetailsState();
}

class _UAppleSignUpAddDetailsState extends State<UAppleSignUpAddDetails> {
