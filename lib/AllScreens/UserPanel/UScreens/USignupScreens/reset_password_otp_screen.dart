...
class ResetPasswordOTPScreen extends StatefulWidget {
  ...
  @override
  State<ResetPasswordOTPScreen> createState() => _ResetPasswordOTPScreen();
}

class _ResetPasswordOTPScreen extends State<ResetPasswordOTPScreen> {
  Timer? _timer;
  int _start = 30;
  String otp = '';
                  ...
                  ? CustomActiveTextButton(
                      onPressed: () {
                        Navigator.of(context).pushReplacement(MaterialPageRoute(
                            builder: (ctx) => EnterNewPasswordScreen(),
