...
class UResetPasswordOTPScreen extends StatefulWidget {
  const UResetPasswordOTPScreen({Key? key}) : super(key: key);

  @override
  State<UResetPasswordOTPScreen> createState() => _UResetPasswordOTPScreen();
}

class _UResetPasswordOTPScreen extends State<UResetPasswordOTPScreen> {
  Timer? _timer;
  int _start = 30;
  String otp = '';
