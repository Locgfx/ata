...
class UCancelBookingScreen extends StatelessWidget {
  final String name;
  const UCancelBookingScreen({Key? key, required this.name}) : super(key: key);
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Your appointment with $name has been canceled. if you want book a new appointment go to home and book your appointment.',
