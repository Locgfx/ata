                      ...
                      previousSessions.isEmpty
                          ...
                          : LazyLoadScrollView(
                              onEndOfPage: () async {
                                ...
                                return _getAllReloadedSessions();
                              },
                              child: ListView.separated(
                                ...
                                itemBuilder: (ctx, index) {
                                  if (index < previousSessions.length) {
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                    DateFormat(
                                                                            "dd MMMM yyyy, hh:MM a")
                                                                        .format(DateTime.parse(previousSessions[index]
                                                                            .bookingDate
                                                                            .toString()))
                                                                        .split(
                                                                            ",")
                                ...
                                itemCount: previousSessions.length + 1,
                              ),
                            ),
                      SizedBox(height: 180),
                    ],
