                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: TextField(
                                ...
                                onTap: () {},
                                decoration:
                                    TextfieldDecoration(label: 'Priya singh')
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: TextField(
                                ...
                                decoration:
                                    TextfieldDecoration(label: '25/02/1993')
                                        .textfieldProfileDecoration()),
                          )
                        ],
                      ),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: TextField(
                                ...
                                decoration: TextfieldDecoration(label: 'Female')
                                    .textfieldProfileDecoration()),
                          )
                        ],
                      ),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: TextField(
                                ...
                                decoration: TextfieldDecoration(label: 'Other')
                                    .textfieldProfileDecoration()),
                          )
                        ],
                      ),
                  ...
                  Row(
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('', style: kManRope_400_16_626A6A),
                          SizedBox(
                            height: 8.h,
                          ),
                          SizedBox(
