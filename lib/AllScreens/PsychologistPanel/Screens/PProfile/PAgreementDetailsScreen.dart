...
class PAgreementDetails extends StatefulWidget {
  const PAgreementDetails({Key? key}) : super(key: key);

  @override
  State<PAgreementDetails> createState() => _PAgreementDetailsState();
}

class _PAgreementDetailsState extends State<PAgreementDetails> {
