...
import 'package:greymatter/AllScreens/PsychologistPanel/Screens/PProfile/PChangeEmailScreen.dart';
import 'package:greymatter/AllScreens/PsychologistPanel/Screens/PProfile/PChangePasswordScreen.dart';
import 'package:greymatter/AllScreens/PsychologistPanel/Screens/PProfile/PDeleteAccountScreen.dart';
...
class PAccountScreen extends StatefulWidget {
  const PAccountScreen({Key? key}) : super(key: key);

  @override
  State<PAccountScreen> createState() =>
      _PAccountScreenState();
}

class _PAccountScreenState extends State<PAccountScreen> {
              ...
              GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => PChangeEmailScreen()));
                },
                child: Container(
              ...
              GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => PDeleteAccount()));
                },
                child: SizedBox(
                  height: 48.h,
                  width: 1.sw,
