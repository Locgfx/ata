...
class PEditPrescriptionViewScreen extends StatefulWidget {
  const PEditPrescriptionViewScreen({Key? key}) : super(key: key);
                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        readOnly: true,
                        decoration:
                        TextfieldDecoration(label: 'Pankaj sharma')
                            .textfielde2f2f4Decoration(),
                      ),
                    ),
                  ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        readOnly: true,
                        decoration: TextfieldDecoration(label: '80 kg')
                            .textfielde2f2f4Decoration(),
                      ),
                    ),
                  ),
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextField(
                      readOnly: true,
                      decoration: TextfieldDecoration(label: '25 yrs')
                          .textfielde2f2f4Decoration(),
                    ),
                  ),
                ],
