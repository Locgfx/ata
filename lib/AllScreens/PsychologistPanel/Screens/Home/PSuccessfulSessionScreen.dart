...
class PSuccessfulSessionScreen extends StatefulWidget {
  const PSuccessfulSessionScreen({Key? key}) : super(key: key);

  @override
  State<PSuccessfulSessionScreen> createState() => _PSuccessfulSessionScreenState();
}

class _PSuccessfulSessionScreenState extends State<PSuccessfulSessionScreen> {
  var title = [
    "session type",
    "Issue",
    "Price",
