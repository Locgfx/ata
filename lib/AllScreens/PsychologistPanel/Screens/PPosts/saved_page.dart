...
class PsychologistSavedScreen extends StatefulWidget {
  ...
  const PsychologistSavedScreen({Key? key, required this.isCommentsViewable}) : super(key: key);
...
class _PsychologistSavedScreenState extends State<PsychologistSavedScreen> {
  ...
  List<UserSavedPostsModel> savedpostlist = [];
  ...
  getData() {
    ...
    resp.then((value) {
      ...
      setState(() {
        for (var v in value) {
          savedpostlist.add(UserSavedPostsModel.fromJson(v));
        }
        isLoading = false;
      });
    });
                        ...
                        children: [
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl: savedpostlist[index].photo.toString(),fit: BoxFit.cover,
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(savedpostlist[index].name.toString(), style: kManRope_500_16_Black),
                                          // SizedBox(height: 1.h),
                          ...
                          isLoading ? SizedBox(
                              ...
                              child: PageView.builder(
                                  itemCount: savedpostlist[index].gallary!.length,
                                  controller: page,
                                  scrollDirection: Axis.horizontal,
                                  pageSnapping: true,
                                  itemBuilder: (BuildContext context,ind) {
                                    return CachedNetworkImage(
                                      imageUrl: savedpostlist[index].gallary![ind].toString(),fit: BoxFit.cover,
                                      placeholder: (context, url) =>  Center(
                                        child: SpinKitThreeBounce(
                                          color: k006D77,
                                          size: 30,
